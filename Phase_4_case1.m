...
%% Input parameters
[grid, rock, fluid, well, simulation] = simulation_input();
...
saveas(gcf, 'oil rate history case 1.png')
...
set(gcf, 'Color', [1,1,1]); % white background
set(gca,'FontSize',14); % bigger font size
saveas(gcf, 'gas rate history case 1.png')
...
set(gcf, 'Color', [1,1,1]); % white background
set(gca,'FontSize',14); % bigger font size
saveas(gcf, 'BHP case 1.png')

% figure(8)
% plot(time_hist, newton_hist, 'DisplayName', 'Two BHP Production Wells'); 

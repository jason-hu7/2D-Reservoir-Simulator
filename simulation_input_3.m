...
function [grid, rock, fluid, well, simulation] = simulation_input_3()

% Reservoir grid description ----------------------------------------------
grid.Nx = 23*3;          % number of grid blocks in x direction
grid.Ny = 23*3;          % number of grid blocks in y direction
...
well(1).location = [35,35];    % well location
...
simulation.max_step = 100;  % max time step size

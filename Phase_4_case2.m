...
%% Input parameters
[grid, rock, fluid, well, simulation] = simulation_input_2();
...
%% load eclipse data
cur_path = pwd(); eclipse_path = fullfile(cur_path, 'Eclipse', 'PHASE4_2.RSM');
eclipse_data = importdata(eclipse_path, ' ', 10);
figure(3)
plot(eclipse_data.data(:,1), eclipse_data.data(:,4), 'DisplayName', 'Eclipse'); hold on;
plot(time_hist, FOPR_hist, 'DisplayName', 'Jason Simulator'); hold off;
